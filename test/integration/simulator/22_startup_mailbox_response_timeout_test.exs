defmodule EtherCAT.Integration.Simulator.StartupMailboxResponseTimeoutTest do
  ...
  test "startup mailbox response timeouts surface as activation-blocked preop configuration failures" do
