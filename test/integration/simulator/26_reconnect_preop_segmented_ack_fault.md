...
slave rebuilds locally back to PREOP, but one later acknowledgement in the
device's PREOP CoE startup download returns malformed protocol data during that
rebuild path before the slave can return to OP.
