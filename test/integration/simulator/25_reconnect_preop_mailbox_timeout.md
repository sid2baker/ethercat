...
slave rebuilds locally back to PREOP, but a later response in the device's
PREOP CoE startup download stalls during that rebuild path before the slave can
return to OP.
