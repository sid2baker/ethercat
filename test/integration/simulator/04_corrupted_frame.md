...
- `EtherCAT.Simulator.Transport.Udp.inject_fault(UdpFault.wrong_idx())`
...
- `EtherCAT.Simulator.Transport.Udp.inject_fault(UdpFault.truncate())`
- `EtherCAT.Simulator.Transport.Udp.inject_fault(UdpFault.unsupported_type())`
- `EtherCAT.Simulator.Transport.Udp.inject_fault(UdpFault.wrong_idx())`
- `EtherCAT.Simulator.Transport.Udp.inject_fault(UdpFault.replay_previous())`
- `EtherCAT.Simulator.Transport.Udp.inject_fault(UdpFault.truncate() |> UdpFault.next(2))`
- `EtherCAT.Simulator.Transport.Udp.inject_fault(UdpFault.script([UdpFault.unsupported_type(), UdpFault.replay_previous()]))`
